...
class UNet(nn.Module):
    def __init__(self, in_channels=3, out_channels=3, init_features=16, 
                 use_stft=False, kernel_size=(7, 1), stride=(4, 1), padding=(3, 0)):
        super(UNet, self).__init__()

        features = init_features
        self.encoder1 = self._block(in_channels, features, kernel_size=kernel_size, stride=stride, padding=padding, name="enc1")
        # self.pool1 = nn.MaxPool1d(kernel_size=2, stride=2)
        self.encoder2 = self._block(features, features * 2, kernel_size=kernel_size, stride=stride, padding=padding, name="enc2")
        # self.pool2 = nn.MaxPool1d(kernel_size=2, stride=2)
        self.encoder3 = self._block(features * 2, features * 4, kernel_size=kernel_size, stride=stride, padding=padding, name="enc3")
        # self.pool3 = nn.MaxPool1d(kernel_size=2, stride=2)
        self.encoder4 = self._block(features * 4, features * 8, kernel_size=kernel_size, stride=stride, padding=padding, name="enc4")
        # self.pool4 = nn.MaxPool1d(kernel_size=2, stride=2)

        self.bottleneck = self._block(features * 8, features * 16, kernel_size=kernel_size, stride=stride, padding=padding, name="bottleneck")
        ...
        self.decoder4 = self._block((features * 8) * 3, features * 8, kernel_size=kernel_size, padding=padding, name="dec4")
        ...
        self.decoder3 = self._block((features * 4) * 3, features * 4, kernel_size=kernel_size, padding=padding, name="dec3")
        ...
        self.decoder2 = self._block((features * 2) * 3, features * 2, kernel_size=kernel_size, padding=padding, name="dec2")
