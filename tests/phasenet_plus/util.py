...
def load_Shelly2020(config=Config()):
    if not os.path.exists("Shelly2020.txt"):
        os.system(
            "wget -O Shelly2020.txt https://agupubs.onlinelibrary.wiley.com/action/downloadSupplement?doi=10.1029%2F2019GL086189&file=grl60250-sup-0002-2019GL086189-ts01.txtf"
        )
