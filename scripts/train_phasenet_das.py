...
args = f"../train.py --model phasenet_das --batch-size=4 --sync-bn --amp --wd=1e-1 --epochs=10  --stack-event --stack-noise --resample-space --resample-time --masking --random-crop --output=model_phasenet_das --wandb --wandb-project=phasenet-das"
